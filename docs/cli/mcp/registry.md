...
<AccordionGroup>
  <Accordion title="Important behavior">
    ...
    - native harness policy discovery releases its temporary connections after preparing the policy snapshot; the native harness owns its execution connections
